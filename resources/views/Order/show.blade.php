            ...
            <div class="am-u-sm-12">
                <form class="am-form">
                    <table class="am-table am-table-striped am-table-hover table-main">
                        <thead>
                        <tr>
                            </th><th class="table-id" width="40px">日期</th><th class="table-title">新增用户数</th><th class="table-type">7日付费下单</th><th class="table-author am-hide-sm-only">30日付费下单</th><th class="table-date am-hide-sm-only">90日付费下单</th><th class="table-date am-hide-sm-only">vip1下单数</th><th class="table-date am-hide-sm-only">vip2下单数</th><th class="table-date am-hide-sm-only">vip3下单数</th><th class="table-set">总收入</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php $sumu=$sumo=$summo=$sumtmo=$sumvo=$sumvo1=$sumvo2=$allmoney=0;?>
