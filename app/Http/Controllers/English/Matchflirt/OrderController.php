...
namespace App\Http\Controllers\English\Matchflirt;
...
class OrderController extends AdController {
    ...
    public function show()
    {
        ...
        $user_infos=DB::table('apps_orders')
            ->where('version','matchflirt')
            ->orderBy('date','desc')
            ->paginate(6);
        return view('Order.show',['user_infos'=>$user_infos,'version'=>'matchforflirt']);
    }
    /**
     * 展示信息总览
     */
    public function listTwoDays()
    {
        ...
        $this->originListTwoDays('matchforflirt','matchforflirt','matchflirt',$appbuy);
    }
    /**
     * 展示充值视图
     */
    public function orderList()
    {
        ...
        $data=$this->originOrderLIst('matchforflirt','matchforflirt','',$search);
