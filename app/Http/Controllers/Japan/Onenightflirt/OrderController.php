...
namespace App\Http\Controllers\Japan\onenightflirt;
...
class OrderController extends AdController {
    ...
    public function show()
    {
        ...
        $user_infos=DB::table('apps_orders')
            ->where('version','onenightflirt_japan')
            ->orderBy('date','desc')
            ->paginate(6);
        return view('Order.show',['user_infos'=>$user_infos,'version'=>'onenightflirt_japan']);
    }
    public function listTwoDays()
    {
        $appbuy=config('conf.app_buytype.onenightflirt');
        $this->originListTwoDays('onenightflirt_japan','onenightflirt','onenightflirt_japan',$appbuy);
    }
    ...
    public function orderList()
    {
        ...
        $data=$this->originOrderLIst('onenightflirt_japan','onenightflirt','',$search);
