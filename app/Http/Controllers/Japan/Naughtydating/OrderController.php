...
namespace App\Http\Controllers\Japan\Naughtydating;
...
class OrderController extends AdController {
    ...
    public function listTwoDays()
    {
        ...
        $this->originListTwoDays('flirtmeet_japan','naughtydating','naughtydating_japan',$appbuy);
    }
 ...
 */
    public function orderList()
    {
        ...
        $data=$this->originOrderLIst('flirtmeet_japan','naughtydating','',$search);
